...
export default function Contact({ auth }) {
    ...
    return (
        <>
            ...
            <main className="min-h-screen bg-gradient-to-br from-navy via-navy/95 to-navy/90 pt-16 md:pt-20 lg:pt-24 pb-16 relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 mb-12">
                        ...
                        <a
                            ...
                            rel="noopener noreferrer"
                               className="bg-gray-50 border-2 border-gray-200 rounded-3xl p-6 shadow-md hover:border-gold hover:shadow-xl hover:shadow-gold/10 hover:scale-[1.02] transition-all duration-300 group"
                        >
                            <div className="flex flex-col items-center text-center">
                                <div className="w-16 h-16 bg-gold shadow-lg rounded-full flex items-center justify-center mb-4 group-hover:scale-105 transition-transform duration-500">
                        ...
                        >
                            <div className="flex flex-col items-center text-center">
                                ...
                                <p className="text-navy font-bold break-all text-base">

                                ...
                                <div className="p-4">
                                    ...
                                    <div className="flex space-x-2">
                                        ...
                                        <button
                                            ...
                                            className={`inline-flex justify-center items-center px-3 py-2 border border-transparent text-xs font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors ${
                                                product.is_featured

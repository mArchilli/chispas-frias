...
export default function Create() {
    ...
    const submit = (e) => {
        ...
        post(route('admin.addons.store'), {
            onSuccess: () => toast.success('Add-on creado exitosamente'),
            ...
            header={
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <h1 className="mt-1 text-xl font-semibold text-slate-900 sm:text-2xl">Nuevo add-on</h1>
                    </div>
                    <Link
            ...
            <div className="mx-auto max-w-2xl">
                <form onSubmit={submit} className="rounded-xl border border-slate-200 bg-white p-5 sm:p-6">
                    <div className="space-y-6">
                        <div>
                            ...
                            <p className="mt-1.5 text-xs text-slate-500">
                                Catálogo global: podés ofrecer el mismo add-on en varios productos.
                            </p>
                    ...
                    <div className="mt-6 flex justify-end gap-3 border-t border-slate-100 pt-6">
                        ...
                        >
                            {processing ? 'Guardando...' : 'Crear add-on'}
                        </button>
                    </div>
                </form>
            </div>

    ...
    return (
        <footer className="bg-navy text-chalk py-12">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    ...
                    <div>
                        ...
                        <div className="space-y-3 text-sm">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <a href="https://wa.me/5491162087768?text=Hola!%20Tengo%20una%20consulta%20sobre%20el%20alquiler%20de%20Chispas%20Fr%C3%ADas" target="_blank" rel="noopener noreferrer" className="hover:text-gold transition">
                                    +54 9 11 6208-7768
                                </a>
                            </div>
                        </div>
                ...
                <div className="border-t border-chalk/20 mt-8 pt-8 text-center text-sm">

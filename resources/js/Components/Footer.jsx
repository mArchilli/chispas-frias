        ...
        <footer className="bg-navy text-chalk py-12">
            <div className="site-shell">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        <h3 className="text-gold text-lg font-semibold mb-4" style={{ textShadow: '1px 1px 3px rgba(0, 0, 0, 0.8)' }}>Pirotecnia fría que eleva tu evento</h3>
                        <img 
                    ...
                    <div>
                        <h3 className="text-gold text-lg font-semibold mb-4">Contacto</h3>
                        <div className="space-y-3 text-sm">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <a href="https://instagram.com/chispasfrias.oficial" target="_blank" rel="noopener noreferrer" className="hover:text-gold transition">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <a href="https://wa.me/5491178886833?text=Hola!%20quiero%20contactarme%20con%20un%20asesor%20de%20Chispas%20Frias%20para%20que%20me%20resuelva%20una%20duda." target="_blank" rel="noopener noreferrer" className="hover:text-gold transition">
                                    +54 9 11 7888-6833
                                </a>
                            </div>
                        </div>
                ...
                <div className="border-t border-chalk/20 mt-8 pt-8 text-sm flex flex-col sm:flex-row items-center justify-between gap-2">
                    <p className="text-right sm:text-left w-full sm:w-auto">&copy; {new Date().getFullYear()} Chispas Frías. Todos los derechos reservados.</p>
                    <p className="text-chalk/50 whitespace-nowrap">Powered by Pampa Labs</p>
                </div>
            </div>
        </footer>
